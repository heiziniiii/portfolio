(function () {
  ...
  if (tabs) {
    tabs.addEventListener('click', function (e) {
      ...
      var hosp = link.getAttribute('data-hosp');
      grid.querySelectorAll('.campaign-card').forEach(function (card) {
        var show = hosp === 'all' || card.getAttribute('data-hosp') === hosp;
